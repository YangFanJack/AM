...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/page_secretory_myApply2.css" type="text/css">
...
<div class="content w clearfix">
    ...
    <div class="detail">
        ...
        <span>活动标题：${activity.actTitle}</span>
        ...
        <div name="" readonly="readonly" disabled="disabled" style="overflow: auto">${activity.actContent}</div>
    </div>
