...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/page_institution_login.css" type="text/css">
...
<div class="content w clearfix">
    <span>管理员登录</span>
    <div class="login">
        <form class="clearfix" method="post" action="managerLogin">
            <input name="username" id="username" class="textBox" type="text" placeholder="用户名8-20位" required="required" onkeyup="checkUsername()"/>
            ...
            <input class="code1" type="text"  placeholder="验证码" required="required"/>
