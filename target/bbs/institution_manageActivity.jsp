...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/page_institution_manageActivity.css" type="text/css">
...
<div class="content w clearfix">
    ...
    <div class="searchActivity clearfix">
        ...
        <div class="searchType clearfix">
            <form action="showPassActivityByPage" method="get">
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination pagination-lg">
                    ...
                    <li>
                        ...
                        <a href="showPassActivityByPage?currentPage=${actPageBean.currentPage-1}&category=${category}&searchString=${searchString}" aria-label="Previous">
                    ...
                    <c:forEach  var="i" begin="1" end="${actPageBean.totalPage}">
                        ...
                        <a href="showPassActivityByPage?currentPage=${i}&category=${category}&searchString=${searchString}">${i}</a></li>
                    </c:forEach>
                    ...
                    <li>
                        ...
                        <a href="showPassActivityByPage?currentPage=${actPageBean.currentPage+1}&totalPage=${actPageBean.totalPage}&category=${category}&searchString=${searchString}" aria-label="Next">
